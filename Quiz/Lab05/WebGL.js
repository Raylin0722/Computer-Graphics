...
var orthoProMatrix = new Matrix4();
...
function draw(x, y){
    ...
    modelMatrix1.translate(0.8, 0, 0);
    modelMatrix2.set(modelMatrix1);
    modelMatrix2.translate(-1.6, 0, 0);
    ...
    backViewMatrix.setLookAt(0, 0, -10, 0, 0, 100, 0, 1, 0);
    orthoProMatrix.setOrtho(-2, 2, -2, 2, 1, 100);
    drawOneViewport(gl, canvas.width / 2, 0, canvas.width / 2, canvas.height /2,
                    0.3, 0.3, 0.3,
                    orthoProMatrix, backViewMatrix, modelMatrix1, modelMatrix2);
