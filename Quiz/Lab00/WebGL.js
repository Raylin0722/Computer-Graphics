...
// make triangle color change by changing the value of vec4 from (1.0, 0.0, 0.0, 1.0) to (0.0, 0.0, 1.0, 1.0)
var FSHADER_SOURCE = `
        void main(){
...
function main(){
    ...
    // make background change by changing value (0.0, 0.0, 0.0, 1.0) to (0.0, 1.0, 0.0, 1.0)
